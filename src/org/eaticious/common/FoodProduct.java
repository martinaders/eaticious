...
public interface FoodProduct extends Serializable {
	...
	/**
	 * Returns the name of this FoodProduct in the requested language as a
	 * String or null if no translation is available
	 * 
	 * @param locale
	...
	/**
	 * @return The code of this product in the requested product classification
	 *         or null if unknown
	 */
	...
	/**
	 * 
	 * @return A Map holding amounts of nutrients per serving of the associated
	 *         recipe
	 */
	...
	/**
	 * 
	 * @return A List of all the food products which can be used in a recipe to
	 ...
	 * @return The season in the requested region at the requested date or null
	 *         if unknown
	 */
	 ...
	 * @return A List with all known production seasons for the ingredient in
	...
	/**
	 * 
	 * @return density of ingredient for correct volume to weight transformation
	 *         (EL, TL to grams)
	 */
	...
	/**
	 * 
	 * @return A list of tags describing any parameter of this product (e.g.
	 ...
	 * @return A Map holding all known producers for this product in the
	 *         consuming region and the corresponding percentage the producer
	 *         adds to the consumer's market
	 */
	public Map<Region, Integer> getProducingRegions(Region consumer);

	/**
	 * The scientific name of the product or null if the scientific name is not
	 * known
	 * 
	 * @return
	 */
	...
	/**
	 * @return A String giving additional information about what to bear in mind
	 ...
	 * 
	 * @return The WeightClass of this FoodProduct or WeightClass.UNKNOWN if the
	 *         weightclass is not specified
	 */
